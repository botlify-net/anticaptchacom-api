...
public final class SolveCaptchaSupplier<R> implements Supplier<SolveResponse<R>> {
   ...
   */
  public SolveCaptchaSupplier(@NotNull final AntiCaptchaComAPI api,
  ...
  private @NotNull Integer startTask(@NotNull final OkHttpClient client) throws AntiCaptchaComException, IOException {
    ...
    final String responseString = api.getHttpRequester().sendPost(client, "https://api.anti-captcha.com/createTask", request);
  ...
  /**
   * This method requests the captcha solution on the anti-captcha.com API
  ...
  private @NotNull SolveResponse<R> getCaptchaSolution(@NotNull final OkHttpClient client,
    ...
    final String processing = TaskStatus.PROCESSING.getValue();
