...
@ToString
@EqualsAndHashCode
public class RecaptchaV2EnterpriseRequest implements SolveRequest {
    ...
    public RecaptchaV2EnterpriseRequest(@NotNull final String websiteURL,
                                        @NotNull final String captchaSiteKey) {
        this.websiteURL = websiteURL;
        this.captchaSiteKey = captchaSiteKey;
    }

    public @NotNull RecaptchaV2EnterpriseRequest setApiDomain(@NotNull final String apiDomain) {
        this.apiDomain = apiDomain;
        return (this);
    }

    public @NotNull RecaptchaV2EnterpriseRequest setEnterprisePayload(@NotNull final Map<String, String> enterprisePayload) {
